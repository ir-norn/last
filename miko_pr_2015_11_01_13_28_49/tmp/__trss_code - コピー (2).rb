...
class Create_VK_action
  ...
  def initialize profile
    @module = Module.new do
      attr_accessor :VK_Replay_file
      attr_accessor :VK_Replay_save
      attr_accessor :VK_Replay_play
# vk key ----
      self.define_singleton_method :extended do | mod |
        rep = Fiber.new do
          loop do
             profile , vk = Fiber.yield true
             p self.flame_get , profile + vk.to_s
          end
        end ; rep.resume
...
# ------
        ...
        self.define_singleton_method :flame_get do flame end
      end # extended
  end # module.new
...
o.VK_Replay_file = "./replay0.yaml"
o.VK_Replay_save = true
o.VK_Replay_play = false

o.extend Create_VK_action_save.new("./replay0.yaml").module
o.extend Create_VK_action_replay.new("./replay0.yaml").module
...
Window.loop do
  ...
  nil  if o.VK_Push? :VK_0
  nil  if o.VK_Down? :VK_1
