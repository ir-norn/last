...
# ---------------------------------------- AnneRose\charactor_select ----------------------------------------
module AnneRose
  class Charactor_select
    def initialize _
      @node_self = _
      @font      = Font.new 30
    ...
    def main
      ...
      load("./AnneRose_src/charactor_select_load.rb" , true ) rescue $!
      @node_self.Task :default do |o| o.Code do
        Window.drawFont(50,  10, "--AnneRose/charactor_select--" , @font)
      end end
    end # def
  end # AnneRose\charactor_select
end # m

# o = ARGV.pop
# AnneRose::Charactor_select.new
