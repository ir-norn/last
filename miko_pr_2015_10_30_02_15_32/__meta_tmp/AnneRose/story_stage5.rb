...
module AnneRose
  class Story_stage5
    ...
    def main
      ...
      load("./AnneRose_src/story_stage5_load.rb" , true ) rescue $!
      @node_self.Task :default do |o| o.Code do
        Window.drawFont(50,  10, "--AnneRose/story_stage5--" , @font)
      end end
    end # def
  end # AnneRose\story_stage5
end # m

# o = ARGV.pop
# AnneRose::Story_stage5.new
