...
# ---------------------------------------- AnneRose\return_display ----------------------------------------
module AnneRose
  class Return_display
    def initialize _
      @node_self = _
      @font      = Font.new 30
    ...
    def main
      ...
      load("./AnneRose_src/return_display_load.rb" , true ) rescue $!
      @node_self.Task :default do |o| o.Code do
        Window.drawFont(50,  10, "--AnneRose/return_display--" , @font)
      end end
    end # def
  end # AnneRose\return_display
end # m

# o = ARGV.pop
# AnneRose::Return_display.new
