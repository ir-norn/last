...
# ---------------------------------------- AnneRose\cpu_mode_stage0 ----------------------------------------
module AnneRose
  class Cpu_mode_stage0
    def initialize _
      @node_self = _
      @font      = Font.new 30
    ...
    def main
      ...
      load("./AnneRose_src/cpu_mode_stage0_load.rb" , true ) rescue $!
      @node_self.Task :default do |o| o.Code do
        Window.drawFont(50,  10, "--AnneRose/cpu_mode_stage0--" , @font)
      end end
    end # def
  end # AnneRose\cpu_mode_stage0
end # m

# o = ARGV.pop
# AnneRose::Cpu_mode_stage0.new
